...
namespace NetUptimeMonitor
{
    ...
    {
        public static string tempDirFailLog = "NetUptimeMonitor_Fail";
        ...
        public static void WriteLog(string inputText)
        {
            ...
            try
            {
                using (StreamWriter streamWriter = new StreamWriter(Path.Combine(path1, "netlog.txt"), true))
                    streamWriter.WriteLine("{0:yyyy-MM-dd HH:mm:ss} - " + inputText, (object)DateTime.Now);
            }
            catch
            {
            }
        ...
        public static void WriteFailLog(string inputText)
        {
            ...
            string path2 = string.Format("{0:yyyy-MM-dd}", (object)DateTime.Now) + ".txt";
            try
            {
